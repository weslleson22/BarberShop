...
-- CreateIndex
CREATE UNIQUE INDEX "clients_email_barbershopId_key" ON "clients"("email", "barbershopId");
...
-- AddForeignKey
ALTER TABLE "appointments" ADD CONSTRAINT "appointments_barberId_fkey" FOREIGN KEY ("barberId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
