...
export default function ClientHeader({ onNewClient, onSearch }: ClientHeaderProps) {
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            ...
            <div className="relative">
              <select
                ...
                className="appearance-none bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white text-sm focus:outline-none focus:border-yellow-400/50 focus:bg-white/10 transition-all cursor-pointer"
              >
                <option value="Todos" className="bg-gray-900">Todos Status</option>
